	...
	<div id="content-wrapper">				
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?= base_url('DataIrigasi/add') ?>"><i class="fas fa-plus"></i> Add New</a>
					</div>
					<div class="card-body">
							...
							<table border="1" class="border border-white" id="dataTable" width="2000px" cellspacing="0">
								...
								<tbody>
									...
									<?php endif ?>
										...
										<td width="80px">
											<a href="<?= base_url('DataIrigasi/edit/'.$datairigasi->id_dataIrigasi) ?>"
											 class="btn btn-small text-white"><i class="fas fa-edit"></i></a>
											<a onclick="deleteConfirm('<?= base_url('DataIrigasi/delete/'.$datairigasi->id_dataIrigasi) ?>')"

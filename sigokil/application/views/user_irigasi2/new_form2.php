			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?= base_url('UserDataIrigasi2') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('UserDataIrigasi2/add') ?>" method="post" enctype="multipart/form-data" >

	...
	<div id="content-wrapper">				
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?= base_url('DataIrigasi2/add') ?>"><i class="fas fa-plus"></i> Add New</a>
					</div>
					<div class="card-body">

						<div class="table-responsive">
							<a class="btn btn-info" href="<?= base_url("DataIrigasi2/action"); ?>">Export ke Excel</a>
							<br>
							<table border="1" class="border border-white table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<?php endif ?>	
										...
										<td width="90">
											<a href="<?= base_url('DataIrigasi2/edit/'.$datairigasi2->id_dataIrigasi2) ?>"
											 class="btn btn-small text-white"><i class="fas fa-edit"></i></a>
											<a onclick="deleteConfirm('<?= base_url('DataIrigasi2/delete/'.$datairigasi2->id_dataIrigasi2) ?>')"

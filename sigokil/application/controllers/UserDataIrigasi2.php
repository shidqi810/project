...
class UserDataIrigasi2 extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view("user_irigasi2/list2", $data);
    ...
    public function add() {
        ...
        $this->load->view("templates/sidebar.php", $data);
        $this->load->view("templates/topbar.php", $data);
        $this->load->view("user_irigasi2/new_form2");
        $this->load->view("templates/footer.php", $data);
    ...
    public function edit($id = null) {
        ...
        $this->load->view("templates/sidebar.php", $data);
        $this->load->view("templates/topbar.php", $data);
        $this->load->view("user_irigasi2/edit_form2", $data);
        $this->load->view("templates/footer.php", $data);
    ...
    public function delete($id=null) {
        ...
        if ($this->dataIrigasi2_model->delete($id)) {
            redirect(base_url('UserDataIrigasi2'));
        }
    }
